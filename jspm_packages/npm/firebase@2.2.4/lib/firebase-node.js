...
(function(Buffer, process) {
    ...
    switch (typeof b) {
      ...
      case "object":
        ...
        if (ea(b)) {
          ...
          for (var e = "",
              f = 0; f < d; f++)
            c.push(e), e = b[f], Ca(a, a.Nd ? a.Nd.call(b, String(f), e) : e, c), e = ",";
          c.push("]");
          break;
        }
        c.push("{");
        d = "";
        for (f in b)
          Object.prototype.hasOwnProperty.call(b, f) && (e = b[f], "function" != typeof e && (c.push(d), Da(f, c), c.push(":"), Ca(a, a.Nd ? a.Nd.call(b, f, e) : e, c), d = ","));
        c.push("}");
        break;
      case "function":
        break;
  ...
  function lb() {}
  lb.prototype.mf = function() {
    return null;
  };
  lb.prototype.te = function() {
    return null;
  };
  var mb = new lb;
  function nb(a, b, c) {
  ...
  nb.prototype.mf = function(a) {
    var b = this.Ja.D;
    if (ob(b, a))
      return b.j().M(a);
    b = null != this.Fd ? new pb(this.Fd, !0, !1) : this.Ja.u();
    return this.Pf.Wa(a, b);
  };
  nb.prototype.te = function(a, b, c) {
    var d = null != this.Fd ? this.Fd : qb(this.Ja);
    a = this.Pf.ie(d, b, 1, c, a);
  ...
  function sb(a, b) {
    for (var c = null,
      ...
      var e = b[d],
          f = e.Xb();
      null === c || f.Z(c.Xb()) || (a.qb.push(c), c = null);
      null === c && (c = new tb(f));
      c.add(e);
    }
    c && a.qb.push(c);
  ...
  Cb.prototype.Xb = function() {
    var a = this.Td.kc();
    return "value" === this.od ? a.path : a.parent().path;
  };
  Cb.prototype.ue = function() {
    return this.od;
  };
  Cb.prototype.Tb = function() {
    return this.pe.Tb(this);
  };
  Cb.prototype.toString = function() {
    return this.Xb().toString() + ":" + this.od + ":" + B(this.Td.hf());
  };
  function Db(a, b, c) {
    this.pe = a;
    this.error = b;
  ...
  function Gb(a, b) {
    ...
    setTimeout(q(this.Ff, this), Math.floor(c));
  }
  Gb.prototype.Ff = function() {
    var a = this.Vd.get(),
        b = {},
        c = !1,
        d;
    for (d in a)
      0 < a[d] && v(this.Lf, d) && (b[d] = a[d], c = !0);
    c && this.ca.Qe(b);
    setTimeout(q(this.Ff, this), Math.floor(6E5 * Math.random()));
  };
  function Hb() {
    this.Bc = {};
  }
  ...
  Tb.prototype.Uc = function() {
    return this.path.e() ? this : new Tb(G(this.path), this.Se);
  };
  Tb.prototype.toString = function() {
    return "Operation(" + this.path + ": " + this.source.toString() + " ack write revert=" + this.Se + ")";
  };
  function Wb(a, b) {
    this.type = Xb;
    this.source = a;
  ...
  function vc(a) {
    if (768 < a.Da)
      throw Error(a.gf + "has a key path longer than 768 bytes (" + a.Da + ").");
    if (32 < a.Pa.length)
      throw Error(a.gf + "path specified exceeds the maximum depth that can be written (32) or object contains a cycle " + wc(a));
  }
  function wc(a) {
  ...
  h = yc.prototype;
  h.set = function(a, b) {
    null == b ? this.Cc.removeItem(this.Kd + a) : this.Cc.setItem(this.Kd + a, B(b));
  };
  h.get = function(a) {
    a = this.Cc.getItem(this.Kd + a);
    return null == a ? null : jb(a);
  };
  h.remove = function(a) {
    this.Cc.removeItem(this.Kd + a);
  };
  h.rf = !1;
  h.toString = function() {
  ...
  function Hc(a) {
    ...
    var b = [],
        c = 8 * a.Zd;
    56 > a.Zb ? a.update(a.Gd, 56 - a.Zb) : a.update(a.Gd, a.Va - (a.Zb - 56));
  ...
  function cd(a, b, c, d) {
    var e = [],
        f = [];
    Oa(b, function(b) {
      "child_changed" === b.type && a.g.ud(b.Ge, b.Ia) && f.push(new D("child_moved", b.Ia, b.Xa));
    });
  ...
  function dd(a, b, c, d, e, f) {
    ...
    Oa(d, function(c) {
      var d = ed(a, c, f);
      Oa(e, function(e) {
        e.Hf(c.type) && b.push(e.createEvent(d, a.V));
      });
    });
  }
  function ed(a, b, c) {
    "value" !== b.type && "child_removed" !== b.type && (b.Ld = c.nf(b.Xa, b.Ia, a.g));
    return b;
  }
  bd.prototype.eg = function(a, b) {
  ...
  h.createEvent = function(a, b) {
    ...
    var c = b.kc().w(a.Xa);
    return new Cb(a.type, this, new R(a.Ia, c, b.n.g), a.Ld);
  };
  h.Tb = function(a) {
    var b = this.pb;
    if ("cancel" === a.ue()) {
  ...
  h = kd.prototype;
  h.matches = function(a) {
    return 0 >= this.g.compare(this.ad, a) && 0 >= this.g.compare(a, this.Dc);
  };
  h.G = function(a, b, c, d, e) {
    this.matches(new E(b, c)) || (c = C);
    return this.we.G(a, b, c, d, e);
  };
  h.ta = function(a, b, c) {
    b.N() && (b = C);
    var d = b.jb(this.g),
  ...
  h.G = function(a, b, c, d, e) {
    ...
    return a.M(b).Z(c) ? a : a.Ab() < this.ja ? this.ra.Ub().G(a, b, c, d, e) : rd(this, a, b, c, d, e);
  };
  h.ta = function(a, b, c) {
    var d;
    if (b.N() || b.e())
      d = C.jb(this.g);
    else if (2 * this.ja < b.Ab() && b.Gc(this.g)) {
      d = C.jb(this.g);
      b = this.Gb ? b.Yb(this.ra.Dc, this.g) : b.Wb(this.ra.ad, this.g);
      for (var e = 0; 0 < b.Oa.length && e < this.ja; ) {
        var f = H(b),
            g;
        if (g = this.Gb ? 0 >= this.g.compare(this.ra.ad, f) : 0 >= this.g.compare(f, this.ra.Dc))
          d = d.Q(f.name, f.S), e++;
        else
          break;
      }
      ...
      if (this.Gb) {
        ...
        b = d.Vb(this.g), k = this.ra.ad, l = this.ra.Dc, m = td(this.g);
      for (var e = 0,
          x = !1; 0 < b.Oa.length; )
  ...
  function rd(a, b, c, d, e, f) {
    ...
    I(b.Ab() == a.ja, "");
    var l = new E(c, d),
        m = a.Gb ? ud(b, a.g) : vd(b, a.g),
        t = a.ra.matches(l);
    if (b.Ga(c)) {
      var x = b.M(c),
          m = e.te(a.g, m, a.Gb);
      null != m && m.name == c && (m = e.te(a.g, m, a.Gb));
      e = null == m ? 1 : g(m, l);
      if (t && !d.e() && 0 <= e)
  ...
  xd.prototype.ab = function(a, b, c, d) {
    var e = new fd,
        f;
    if (b.type === Sb)
      b.source.re ? c = yd(this, a, b.path, b.Ha, c, d, e) : (I(b.source.lf, "Unknown source."), f = b.source.Ye, c = zd(this, a, b.path, b.Ha, c, d, f, e));
    else if (b.type === Ad)
      b.source.re ? c = Bd(this, a, b.path, b.children, c, d, e) : (I(b.source.lf, "Unknown source."), f = b.source.Ye, c = Cd(this, a, b.path, b.children, c, d, f, e));
    else if (b.type === Ub)
      if (b.Se)
  ...
  function Fd(a, b, c, d, e, f) {
    ...
    if (c.e())
      ...
      var l = O(c);
      if (".priority" == l)
        I(1 == rc(c), "Can't have a priority with additional path components"), f = g.j(), k = b.u().j(), d = d.ed(c, f, k), f = null != d ? a.I.da(f, d) : g.j();
      else {
        var m = G(c);
        ob(g, l) ? (k = b.u().j(), d = d.ed(c, g.j(), k), d = null != d ? g.j().M(l).G(m, d) : g.j().M(l)) : d = d.Wa(l, b.u());
  ...
  h.Ud = function(a, b) {
    ...
    n(a) || (a = null);
    c.cc = a;
    null != b ? (c.Ib = !0, c.ub = b) : (c.Ib = !1, c.ub = "");
    return c;
  };
  h.nd = function(a, b) {
    var c = Zd(this);
  ...
  function ae(a) {
    var b = {};
    a.la && (b.sp = a.cc, a.Ib && (b.sn = a.ub));
    a.na && (b.ep = a.$b, a.Qb && (b.en = a.sb));
    if (a.ia) {
      b.l = a.ja;
      var c = a.Kb;
      "" === c && (c = qd(a) ? "l" : "r");
  ...
  function ce(a) {
    ...
    b.orderBy = B(c);
    a.la && (b.startAt = B(a.cc), a.Ib && (b.startAt += "," + B(a.ub)));
    a.na && (b.endAt = B(a.$b), a.Qb && (b.endAt += "," + B(a.sb)));
  ...
  function ee(a, b, c) {
    ...
    return new de(d, a.bc);
  }
  function ge(a, b, c) {
    var d = na(a.vd, function(a) {
      if (a === Nd)
        return a;
      var d = c.get(b.name);
  ...
  h.da = function(a) {
    return this.m.e() ? this : new S(this.m, a, this.tb);
  };
  h.M = function(a) {
    if (".priority" === a)
      return this.A();
  ...
  h.Q = function(a, b) {
    ...
    var c = new E(a, b),
        d,
        e;
    b.e() ? (d = this.m.remove(a), c = ge(this.tb, c, this.m)) : (d = this.m.Ma(a, b), c = ee(this.tb, c, this.m));
    e = d.e() ? C : this.ba;
    return new S(d, e, c);
  };
  h.G = function(a, b) {
  ...
  function vd(a, b) {
    var c;
    c = (c = me(a, b)) ? (c = c.dc()) && c.name : a.m.dc();
    return c ? new E(c, a.m.get(c)) : null;
  }
  h.U = function(a, b) {
    var c = me(this, a);
  ...
  h.Vb = function(a) {
    return this.Wb(a.Qc(), a);
  };
  h.Wb = function(a, b) {
    var c = me(this, b);
    if (c)
      return c.Wb(a, function(a) {
        return a;
      });
    for (var c = this.m.Wb(a.name, Nb),
        d = bc(c); null != d && 0 > b.compare(d, a); )
      H(c), d = bc(c);
    return c;
  };
  h.of = function(a) {
    return this.Yb(a.Nc(), a);
  };
  h.Yb = function(a, b) {
    var c = me(this, b);
    if (c)
  ...
  h.jb = function(a) {
    if (a === Td || ta(this.tb.bc, a.toString()))
      return this;
    var b = this.tb,
        c = this.m;
  ...
  h.Gc = function(a) {
    return a === Td || ta(this.tb.bc, a.toString());
  };
  h.Z = function(a) {
    if (a === this)
      return !0;
  ...
  function me(a, b) {
    return b === Td ? null : a.tb.get(b.toString());
  }
  h.toString = function() {
    return B(this.K(!0));
  };
  ...
  function oe(a) {
    ...
    this.ef = this.count - 1;
    this.ag = a + 1 & parseInt(Array(this.count + 1).join("1"), 2);
  }
  function pe(a) {
    var b = !(a.ag & 1 << a.ef);
    a.ef--;
  ...
  function Dd(a, b, c, d) {
    return new Gd(new pb(b, c, d), a.Rd);
  }
  function Hd(a) {
  ...
  h.ab = function(a, b, c) {
    a.type === Ad && null !== a.source.Fb && (I(qb(this.Ja), "We should always have a full cache before handling merges"), I(Hd(this.Ja), "Missing event cache, even though we have a server cache"));
    var d = this.Ja;
    a = this.Ef.ab(d, a, b, c);
    b = this.Ef;
    c = a.de;
    I(c.D.j().Gc(b.I.g), "Event snap not indexed");
    I(c.u().j().Gc(b.I.g), "Server snap not indexed");
    I(Eb(a.de.u()) || !Eb(d.u()), "Once a server snap is complete, it should never go back");
    this.Ja = a.de;
    return te(this, a.bg, a.de.D.j(), null);
  };
  function ue(a, b) {
    var c = a.Ja.D,
        d = [];
  ...
  we.prototype.toString = function() {
    return this.re ? "user" : this.Ye ? "server(queryID=" + this.Fb + ")" : "server";
  };
  function ye(a, b) {
    this.f = Mc("p:rest:");
    this.H = a;
  ...
  h.Md = function(a) {
    ...
    if (d) {
      if (e)
        this.T = Ye(this.za, Ze, F), this.Jc = 0 < this.za.length ? this.za[this.za.length - 1].ee : -1;
      else if (c.Ha)
        this.T = this.T.Md(c.path);
      else {
        var k = this;
        r(c.children, function(a, b) {
          k.T = k.T.Md(c.path.w(b));
        });
      }
      return c.path;
    }
  ...
  h.ua = function(a, b, c, d) {
    if (c || d) {
      ...
      return !d && e.e() ? b : d || null != b || null != Se(e, F) ? (e = Ye(this.za, function(b) {
        return (b.visible || d) && (!c || !(0 <= Na(c, b.ee))) && (b.path.contains(a) || a.contains(b.path));
  ...
  h.ed = function(a, b, c) {
    return this.W.ed(this.Jb, a, b, c);
  };
  h.rc = function(a) {
    return this.W.rc(this.Jb.w(a));
  };
  h.ie = function(a, b, c, d, e) {
    return this.W.ie(this.Jb, a, b, c, d, e);
  };
  h.Wa = function(a, b) {
  ...
  ef.prototype.Lb = function(a, b) {
    ...
    g = f.Lb(a, b, new $e(c, this.Eb), d, g);
      ...
      if (b && !g && (d = this.sa.subtree(d), !d.e()))
        for (var d = tf(d),
          ...
          var l = d[k],
              m = l.V,
              l = uf(this, l);
          this.Kc.Ue(m, vf(this, m), l.rd, l.J);
        }
      if (!g && 0 < e.length && !c)
        if (b)
          this.Kc.Wd(a, null);
  ...
  function of(a, b, c) {
    ...
    return d.ab(c, new $e(b, a.Eb), null);
  }
  function gf(a, b) {
    return xf(a, b, a.sa, null, new $e(F, a.Eb));
  }
  ...
  h.path = function() {
    return new K(null === this.Wc ? this.Bd : this.Wc.path() + "/" + this.Bd);
  };
  h.name = function() {
    return this.Bd;
  };
  ...
  function Df(a) {
    if (null !== a.Wc) {
      var b = a.Wc,
          ...
          d = a.e(),
          e = v(b.B.children, c);
      d && e ? (delete b.B.children[c], b.B.gd--, Df(b)) : d || e || (b.B.children[c] = a.B, b.B.gd++, Df(b));
    }
  }
  ;
  function Gf(a) {
  ...
  Gf.prototype.ae = function(a, b) {
    for (var c = this.Lc[a] || [],
        d = 0; d < c.length; d++)
      c[d].xc.apply(c[d].La, Array.prototype.slice.call(arguments, 1));
  };
  Gf.prototype.Bb = function(a, b, c) {
    Hf(this, a);
    this.Lc[a] = this.Lc[a] || [];
    this.Lc[a].push({
      xc: b,
  ...
  Gf.prototype.ec = function(a, b, c) {
    Hf(this, a);
    a = this.Lc[a] || [];
  ...
  function Jf() {
    ...
    if ("undefined" !== typeof window && "undefined" !== typeof window.addEventListener) {
      ...
      window.addEventListener("online", function() {
        a.gc || (a.gc = !0, a.ae("online", !0));
      }, !1);
      window.addEventListener("offline", function() {
        a.gc && (a.gc = !1, a.ae("online", !1));
      }, !1);
    }
  }
  ma(Jf, Gf);
  Jf.prototype.ve = function(a) {
  ...
  function eg(a, b, c) {
    ...
    this.$d = b || {};
    this.$a = c || {};
    this.hd.remember || (this.hd.remember = "default");
  }
  ...
  ;
  function hg(a, b) {
    this.Me = ["session", a.Jd, a.zb].join(":");
    this.Xd = b;
  }
  ...
  hg.prototype.get = function() {
    var a = Qa(this.Xd, q(this.ng, this)),
        a = Pa(a, function(a) {
          return null !== a;
        });
    Wa(a, function(a, c) {
  ...
  function qg(a) {
    ...
    this.yc = a;
    this.Yd = "*";
    ig() ? this.Oc = this.td = jg() : (this.Oc = window.opener, this.td = window);
    if (!b.Oc)
      throw "Unable to find relay frame";
    kg(this.td, "message", q(this.fc, this));
    kg(this.td, "message", q(this.zf, this));
    try {
      rg(this, {a: "ready"});
    } catch (c) {
    ...
    kg(window, "unload", q(this.xg, this));
  }
  function rg(a, b) {
    b = B(b);
    ig() ? a.Oc.doPost(b, a.Yd) : a.Oc.postMessage(b, a.Yd);
  }
  qg.prototype.fc = function(a) {
    var b = this,
        c;
    try {
      c = jb(a.data);
    } catch (d) {}
    c && "request" === c.a && (lg(window, "message", this.fc), this.Yd = a.origin, this.yc && setTimeout(function() {
      b.yc(b.Yd, c.d, function(a, c) {
        b.$f = !c;
        b.yc = void 0;
        rg(b, {
          a: "response",
  ...
  qg.prototype.xg = function() {
    try {
      lg(this.td, "message", this.zf);
    } catch (a) {}
    this.yc && (rg(this, {
      a: "error",
  ...
  qg.prototype.zf = function(a) {
    if (this.$f && "die" === a.data)
      try {
        window.close();
      } catch (b) {}
  };
  ...
  xg.prototype.open = function(a, b, c) {
    ...
    (g = window.open(a, "_blank", "location=no")) && ha(g.addEventListener) ? (g.addEventListener("loadstart", function(a) {
      ...
      b && (a = ng(a.url), g.removeEventListener("exit", d), g.close(), a = new eg(null, null, {
        requestId: e.nc,
        requestKey: a
      }), e.Cf.requestWithCredential("/auth/session", a, c), c = null);
  ...
  function Bg(a) {
    ...
    var b = a.qc.get();
    b && b.token ? (Dg(a, b), a.af(b.token, function(c, d) {
  ...
  function Cg(a) {
    ...
    if (b) {
      ...
      Kg(a, d, "/auth/session", c, function() {
        this.Oe = !1;
      }.bind(a));
    }
  }
  ...
  function Kg(a, b, c, d, e) {
    Mg(a, b, c, d, function(b, c) {
      !b && c && c.token && c.uid ? Gg(a, c.token, c, d.hd, function(a, b) {
        a ? Q(e, a) : Q(e, null, b);
  ...
  function Mg(a, b, c, d, e) {
    ...
    }, 0) : (b = new (b.shift())(d.$d), d = fb(d.$a), d.v = "node-2.2.4", d.transport = b.Nb(), d.suppress_status_codes = !0, a = og() + "/" + a.H.zb + c, b.open(a, d, function(a, b) {
      if (a)
        Q(e, a);
      else if (b && b.error) {
  ...
  function Og(a, b, c) {
    a.le = b;
    a.Cb = c;
    a.le < a.Pb && (a.Cb(), a.Cb = null);
  }
  function Pg(a, b, c) {
    for (a.Id[b] = c; a.Id[a.Pb]; ) {
      var d = a.Id[a.Pb];
      delete a.Id[a.Pb];
      ...
      if (a.Pb === a.le) {
        a.Cb && (clearTimeout(a.Cb), a.Cb(), a.Cb = null);
        break;
      }
      a.Pb++;
    }
        ...
        c.Sa = new Tg(function(a, b, d, k, l) {
          ...
          if (c.Sa)
            if (c.ob && (clearTimeout(c.ob), c.ob = null), c.Ec = !0, "start" == a)
              ...
              b ? (c.Sa.Kf = !1, Og(c.yf, b, function() {
                c.fb();
              })) : c.fb();
            else
  ...
  Qg.isAvailable = function() {
    return !Sg && !("object" === typeof window && window.chrome && window.chrome.extension && !/^chrome/.test(window.location.href)) && !("object" === typeof Windows && "object" === typeof Windows.Vg) && (Rg || !1);
  };
  h = Qg.prototype;
  h.yd = function() {};
  h.$c = function() {
    ...
    this.wf && (document.body.removeChild(this.wf), this.wf = null);
    this.ob && (clearTimeout(this.ob), this.ob = null);
  };
  h.fb = function() {
    this.wb || (this.f("Longpoll is closing itself"), this.$c(), this.ka && (this.ka(this.Ec), this.ka = null));
  };
  h.close = function() {
    this.wb || (this.f("Longpoll is being closed."), this.$c());
  };
  h.send = function(a) {
    a = B(a);
    this.mb += a.length;
  ...
  Tg.prototype.close = function() {
    this.ge = !1;
    if (this.Ad) {
      this.Ad.Xg.body.innerHTML = "";
      var a = this;
      setTimeout(function() {
        null !== a.Ad && (document.body.removeChild(a.Ad), a.Ad = null);
      }, Math.floor(0));
    }
    if (this.Fe) {
      var b = {disconn: "t"};
  ...
  function Wg(a) {
    if (a.ge && a.Kf && a.Le.count() < (0 < a.Xc.length ? 2 : 1)) {
      a.oe++;
      var b = {};
      b.id = a.Fe;
      b.pw = a.xf;
      ...
      for (var b = a.dd(b),
          c = "",
          d = 0; 0 < a.Xc.length; )
        if (1870 >= a.Xc[0].ff.length + 30 + c.length) {
          var e = a.Xc.shift(),
              c = c + "&seg" + d + "=" + e.Jg + "&ts" + d + "=" + e.Rg + "&d" + d + "=" + e.ff;
          d++;
        } else
          break;
      Yg(a, b + c, a.oe);
  ...
  function ch(a, b, c) {
    ...
    b.host !== b.Na && (this.Ob = this.Ob + "&ns=" + b.zb);
  ...
  ch.prototype.open = function(a, b) {
    ...
    try {
      this.va = new bh(this.Ob, [], {headers: {"User-Agent": "Firebase/5/2.2.4/" + process.platform + "/Node"}});
    } catch (c) {
  ...
  h.fb = function() {
    this.wb || (this.f("WebSocket is closing itself"), this.$c(), this.gb && (this.gb(this.Ec), this.gb = null));
  };
  h.close = function() {
    this.wb || (this.f("WebSocket is being closed"), this.$c());
  };
  function eh(a) {
    clearInterval(a.Hc);
  ...
  function hh(a, b) {
    var c = ch && ch.isAvailable(),
        d = c && !(Ac.rf || !0 === Ac.get("previous_websocket_failure"));
    b.Ug && (c || P("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."), d = !0);
    if (d)
      a.bd = [ch];
    else {
      var e = a.bd = [];
  ...
  function lh(a) {
    ...
    0 < b && (a.sd = setTimeout(function() {
      a.sd = null;
      a.xb || (a.L && 102400 < a.L.lb ? (a.f("Connection exceeded healthy timeout but has received " + a.L.lb + " bytes.  Marking connection healthy."), a.xb = !0, a.L.yd()) : a.L && 10240 < a.L.mb ? a.f("Connection exceeded healthy timeout but has sent " + a.L.mb + " bytes.  Leaving connection alive.") : (a.f("Closing unhealthy connection after timeout."), a.close()));
    }, Math.floor(b)));
  }
  function nh(a, b) {
    return function(c) {
      b === a.L ? (a.L = null, c || 0 !== a.Ta ? 1 === a.Ta && a.f("Realtime connection lost.") : (a.f("Realtime connection failed."), "s-" === a.H.Na.substr(0, 2) && (Ac.remove("host:" + a.H.host), a.H.Na = a.H.host)), a.close()) : b === a.F ? (a.f("Secondary connection lost."), c = a.F, a.F = null, a.cd !== c && a.Zc !== c || a.close()) : a.f("closing an old connection");
    };
  }
  function mh(a, b) {
    return function(c) {
      if (2 != a.Ta)
        if (b === a.Zc) {
          ...
          if ("c" == d) {
            if (d = Tc("t", c), "d" in c)
              if (c = c.d, "h" === d) {
                ...
                a.Sd = c.s;
                Dc(a.H, f);
                0 == a.Ta && (a.L.start(), oh(a, a.L, d), "5" !== e && P("Protocol version mismatch detected"), c = a.Mf, (c = 1 < c.bd.length ? c.bd[1] : null) && ph(a, c));
              } else if ("n" === d) {
                a.f("recvd end transmission on primary");
                a.Zc = a.F;
                for (c = 0; c < a.Hd.length; ++c)
                  a.Dd(a.Hd[c]);
                a.Hd = [];
                qh(a);
              } else
          ...
          if (d = Tc("t", c), c = Tc("d", c), "c" == d)
            "t" in c && (c = c.t, "a" === c ? uh(a) : "r" === c ? (a.f("Got a reset on secondary, closing it"), a.F.close(), a.cd !== a.F && a.Zc !== a.F || a.close()) : "o" === c && (a.f("got pong on secondary."), a.Jf--, uh(a)));
          else if ("d" == d)
            a.Hd.push(c);
          else
  ...
  function qh(a) {
    a.cd === a.F && a.Zc === a.F && (a.f("cleaning up and promoting a connection: " + a.F.me), a.L = a.F, a.F = null);
  }
  function uh(a) {
    0 >= a.Jf ? (a.f("Secondary connection is healthy."), a.xb = !0, a.F.yd(), a.F.start(), a.f("sending client ack on secondary"), a.F.send({
      t: "c",
      d: {
        t: "a",
        d: {}
    ...
    }), a.cd = a.F, qh(a)) : (a.f("sending ping on secondary."), a.F.send({
      t: "c",
      d: {
        t: "p",
        d: {}
  ...
  kh.prototype.Dd = function(a) {
    sh(this);
    this.fc(a);
  };
  function sh(a) {
    a.xb || (a.Ne--, 0 >= a.Ne && (a.f("Primary connection is healthy."), a.xb = !0, a.L.yd()));
  }
  function ph(a, b) {
    a.F = new b("c:" + a.id + ":" + a.bf++, a.H, a.Sd);
    a.Jf = b.responsesRequiredToBeHealthy || 0;
  ...
  function oh(a, b, c) {
    ...
    0 === a.Ne ? (a.f("Primary connection is healthy."), a.xb = !0) : setTimeout(function() {
      th(a);
    }, Math.floor(5E3));
  }
  function th(a) {
    a.xb || 1 !== a.Ta || (a.f("sending ping on primary."), vh(a, {
      t: "c",
      d: {
        t: "p",
        d: {}
  ...
  function rh(a) {
    ...
    a.sd && (clearTimeout(a.sd), a.sd = null);
  }
  ;
  function wh(a, b, c, d) {
    this.id = xh++;
    ...
    yh(this, 0);
    Kf.rb().Bb("visible", this.yg, this);
    -1 === a.host.indexOf("fblocal") && Jf.rb().Bb("online", this.wg, this);
  }
  var xh = 0,
      zh = 0;
  h = wh.prototype;
  ...
  h.P = function(a, b, c) {
    ...
    b && (this.f("Admin auth credential detected.  Reducing max reconnect time."), this.zd = 3E4);
  };
  h.be = function(a) {
    delete this.Ea;
  ...
  function Ch(a) {
    var b = a.Ea;
    a.ma && b && a.Ca("auth", {cred: b.fg}, function(c) {
      var d = c.s;
      c = c.d || "error";
      "ok" !== d && a.Ea === b && delete a.Ea;
      b.kf ? "ok" !== d && b.fd && b.fd(d, c) : (b.kf = !0, b.xc && b.xc(d, c));
    });
  }
  h.Nf = function(a, b) {
  ...
  h.Qe = function(a) {
    this.ma && (a = {c: a}, this.f("reportStats", a), this.Ca("s", a, function(a) {
  ...
  h.Dd = function(a) {
    if ("r" in a) {
      ...
      "a" in a && (b = a.a, c = a.b, this.f("handleServerMessage", b, c), "d" === b ? this.Db(c.p, c.d, !1, c.t) : "m" === b ? this.Db(c.p, c.d, !0, c.t) : "c" === b ? Gh(this, c.p, c.q) : "ac" === b ? (a = c.s, b = c.d, c = this.Ea, delete this.Ea, c && c.fd && c.fd(a, b)) : "sd" === b ? this.Te ? this.Te(c) : "msg" in c && "undefined" !== typeof console && console.log("FIREBASE: " + c.msg.replace("\n", "\nFIREBASE: ")) : Nc("Unrecognized action received from server: " + B(b) + "\nAre you using the latest client?"));
    }
  };
  h.Tc = function(a) {
    ...
    this.jf && (a = {}, a["sdk.js." + "2.2.4".replace(/\./g, "-")] = 1, "undefined" !== typeof window && (window.cordova || window.phonegap || window.PhoneGap) && /ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(navigator.userAgent) && (a["framework.cordova"] = 1), this.Qe(a));
    Hh(this);
    this.jf = !1;
    this.Rc(!0);
  };
  ...
  h.yg = function(a) {
    a && !this.tc && this.Za === this.zd && (this.f("Window became visible.  Reducing delay."), this.Za = 1E3, this.Ra || yh(this, 0));
    this.tc = a;
  };
  h.wg = function(a) {
    a ? (this.f("Browser went online."), this.Za = 1E3, this.Ra || yh(this, 0)) : (this.f("Browser went offline.  Killing connection."), this.Ra && this.Ra.close());
  };
  h.Bf = function() {
  ...
  h.vb = function() {
    this.ze = !0;
    this.Ra ? this.Ra.close() : (this.Rb && (clearTimeout(this.Rb), this.Rb = null), this.ma && this.Bf());
  };
  h.pc = function() {
    this.ze = !1;
    this.Za = 1E3;
  ...
  R.prototype.exportVal = R.prototype.hf;
  ...
  R.prototype.hasChildren = R.prototype.qd;
  ...
  R.prototype.numChildren = R.prototype.Ab;
  ...
  function Kh(a, b) {
    ...
    this.Cd = 1;
    this.Qa = null;
    b || 0 <= ("object" === typeof window && window.navigator && window.navigator.userAgent || "").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i) ? (this.ca = new ye(this.H, q(this.Db, this)), setTimeout(q(this.Rc, this, !0), 0)) : this.ca = this.Qa = new wh(this.H, q(this.Db, this), q(this.Rc, this), q(this.Ke, this));
    this.Pg = Mb(a, q(function() {
    ...
    this.wd = new ef({
      Ue: function(a, b, f, g) {
        b = [];
        f = c.xe.j(a.path);
        f.e() || (b = gf(c.wd, new Rb(xe, a.path, f)), setTimeout(function() {
          g("ok");
        }, 0));
        return b;
      },
    ...
    Lh(this, "connected", !1);
    this.ka = new nc;
    this.P = new Ag(a, q(this.ca.P, this.ca), q(this.ca.be, this.ca), q(this.He, this));
    this.md = 0;
    this.ye = null;
    this.O = new ef({
      Ue: function(a, b, f, g) {
        c.ca.tf(a, f, b, function(b, e) {
          var f = g(b, e);
          wb(c.ea, a.path, f);
        });
        return [];
  ...
  function Mh(a) {
    a = a.xe.j(new K(".info/serverTimeOffset")).K() || 0;
  ...
  h.update = function(a, b, c) {
    ...
    if (d)
      yb("update() called with empty data.  Don't do anything."), Qh(c, "ok");
    else {
      var g = this.Cd++,
          k = hf(this.O, a, f, g);
      sb(this.ea, k);
      var l = this;
      this.ca.uf(a.toString(), b, function(b, d) {
        var e = "ok" === b;
  ...
  h.Ed = function(a, b) {
    var c = this;
    this.ca.Ed(a.toString(), function(d, e) {
      "ok" === d && cg(c.ka, a);
      Qh(b, d, e);
    });
  };
  ...
  function Uh(a, b, c, d) {
    ...
    for (f in c)
      e = !1;
    e ? (yb("onDisconnect().update() called with empty data.  Don't do anything."), Qh(d, "ok")) : a.ca.Af(b.toString(), c, function(e, f) {
      if ("ok" === e)
        for (var l in c) {
          var m = L(c[l]);
          a.ka.lc(b.w(l), m);
  ...
  function Vh(a, b, c) {
    c = ".info" === O(b.path) ? a.wd.Lb(b, c) : a.O.Lb(b, c);
    ub(a.ea, b.path, c);
  }
  h.vb = function() {
    this.Qa && this.Qa.vb();
  ...
  h.Ve = function(a) {
    if ("undefined" !== typeof console) {
      a ? (this.Vd || (this.Vd = new Fb(this.Ua)), a = this.Vd.get()) : a = this.Ua.get();
  ...
  function Wh(a, b, c, d, e) {
    ...
    if (n(d)) {
      ...
      c.ld = e;
      c.Aa = a.Cd++;
      c = ff(a.O, b, e, c.Aa, c.$e);
      wb(a.ea, b, c);
      Xh(a);
    } else
      c.ce(), c.kd = null, c.ld = null, c.J && (a = new R(c.jd, new T(a, c.path), M), c.J(null, !1, a));
  }
  function Xh(a, b) {
    var c = b || a.sc;
    b || Yh(a, c);
  ...
  function bi(a, b, c) {
    if (0 !== b.length) {
      for (var d = [],
        ...
        if (5 === k.status)
          m = !0, t = k.fe, e = e.concat(jf(a.O, k.Aa, !0));
        else if (1 === k.status)
          if (25 <= k.If)
            ...
            n(J) ? (Qf("transaction failed: Data returned ", J, k.path), l = L(J), "object" === typeof J && null != J && v(J, ".priority") || (l = l.da(x.A())), x = k.Aa, J = Nh(a), J = pc(l, J), k.kd = l, k.ld = J, k.Aa = a.Cd++, Va(f, x), e = e.concat(ff(a.O, k.path, J, k.Aa, k.$e)), e = e.concat(jf(a.O, x, !0))) : (m = !0, t = "nodata", e = e.concat(jf(a.O, k.Aa, !0)));
          }
        wb(a.ea, c, e);
        e = [];
        m && (b[g].status = 3, setTimeout(b[g].ce, Math.floor(0)), b[g].J && ("nodata" === t ? (k = new T(a, b[g].path), d.push(q(b[g].J, null, null, !1, new R(b[g].jd, k, M)))) : d.push(q(b[g].J, null, Error(t), !1, null))));
      }
      Yh(a, a.sc);
  ...
  function di(a, b) {
    ...
    if (null !== c) {
      for (var d = [],
          ...
          f = -1,
          g = 0; g < c.length; g++)
        4 !== c[g].status && (2 === c[g].status ? (I(f === g - 1, "All SENT items should be at beginning of queue."), f = g, c[g].status = 4, c[g].fe = "set") : (I(1 === c[g].status, "Unexpected transaction status in abort"), c[g].ce(), e = e.concat(jf(a.O, c[g].Aa, !0)), c[g].J && d.push(q(c[g].J, null, Error("set"), !1, null))));
  ...
  ca(W);
  W.prototype.vb = function() {
    for (var a in this.mc)
      this.mc[a].vb();
  };
  W.prototype.interrupt = W.prototype.vb;
  ...
  Y.prototype.Bb = function(a, b, c, d) {
    y("Query.on", 2, 4, arguments.length);
    Tf("Query.on", a, !1);
    A("Query.on", 2, b, !1);
    var e = hi("Query.on", c, d);
    if ("value" === a)
      Vh(this.k, this, new hd(b, e.cancel || null, e.La || null));
    else {
      var f = {};
      f[a] = b;
      Vh(this.k, this, new id(f, e.cancel, e.La));
    }
    return b;
  };
  Y.prototype.on = Y.prototype.Bb;
  Y.prototype.ec = function(a, b, c) {
    ...
    e = this.k;
    d = ".info" === O(this.path) ? e.wd.hb(this, d) : e.O.hb(this, d);
    ub(e.ea, this.path, d);
  };
  Y.prototype.off = Y.prototype.ec;
  Y.prototype.zg = function(a, b) {
    function c(g) {
      f && (f = !1, e.ec(a, c), b.call(d.La, g));
    }
    ...
    var d = hi("Query.once", arguments[2], arguments[3]),
        e = this,
        f = !0;
    this.Bb(a, c, function(b) {
      e.ec(a, c);
      d.cancel && d.cancel.call(d.La, b);
    });
  };
  Y.prototype.once = Y.prototype.zg;
  ...
  Y.prototype.orderByChild = Y.prototype.Ag;
  ...
  Y.prototype.orderByKey = Y.prototype.Bg;
  ...
  Y.prototype.orderByPriority = Y.prototype.Cg;
  ...
  Y.prototype.orderByValue = Y.prototype.Dg;
  Y.prototype.Ud = function(a, b) {
  ...
  Y.prototype.startAt = Y.prototype.Ud;
  Y.prototype.nd = function(a, b) {
  ...
  Y.prototype.endAt = Y.prototype.nd;
  ...
  Z.uc.prototype.simpleListen = Z.uc.prototype.Og;
  wh.prototype.gg = function(a, b) {
    this.Ca("echo", {d: a}, b);
  };
  Z.uc.prototype.echo = Z.uc.prototype.gg;
  wh.prototype.interrupt = wh.prototype.vb;
  Z.Rf = kh;
  Z.RealTimeConnection = Z.Rf;
  ...
  function T(a, b) {
    ...
    if (a instanceof Kh)
      ...
      e = d.toString();
      var f;
      !(f = !p(c.host) || 0 === c.host.length || !Nf(c.zb)) && (f = 0 !== e.length) && (e && (e = e.replace(/^\/*\.info(\/|$)/, "/")), f = !(p(e) && 0 !== e.length && !Mf.test(e)));
      if (f)
  ...
  T.prototype.Lg = function(a, b) {
    ...
    this.k.Hb(this.path.w(".priority"), a, null, b);
  };
  T.prototype.setPriority = T.prototype.Lg;
  ...
  T.prototype.authWithCustomToken = T.prototype.Vf;
  ...
  T.prototype.authWithOAuthPopup = T.prototype.Wf;
  T.prototype.Xf = function(a, b, c) {
    ...
    var e = [sg],
        f = gg(c);
    "anonymous" === a || "firebase" === a ? Q(b, U("TRANSPORT_UNAVAILABLE")) : (Bc.set("redirect_client_options", f.hd), Kg(d, e, "/auth/" + a, f, b));
  };
  T.prototype.authWithOAuthRedirect = T.prototype.Xf;
  T.prototype.Yf = function(a, b, c, d) {
  ...
  T.prototype.authWithOAuthToken = T.prototype.Yf;
  T.prototype.Uf = function(a, b) {
  ...
  T.prototype.authAnonymously = T.prototype.Uf;
  ...
  T.prototype.authWithPassword = T.prototype.Zf;
  T.prototype.ne = function(a, b) {
  ...
  T.prototype.createUser = T.prototype.ne;
  ...
  T.prototype.removeUser = T.prototype.Pe;
  ...
  T.prototype.changePassword = T.prototype.ke;
  T.prototype.je = function(a, b) {
  ...
  T.prototype.changeEmail = T.prototype.je;
  ...
  T.prototype.resetPassword = T.prototype.Re;
