...
(function(Buffer) {
  (function() {
    ...
    h.ta = function(a, b, c) {
      ...
      if (b.N() || b.e())
        ...
        if (this.Ib) {
          ...
          b = d.Xb(this.g), k = this.ra.fd, l = this.ra.Fc, m = ud(this.g);
        for (var e = 0,
            y = !1; 0 < b.Pa.length; )
    ...
    function Pg(a, b, c, d, e) {
      ...
      }, 0) : (b = new (b.shift())(d.de), d = ib(d.ab), d.v = "js-2.2.2", d.transport = b.Bc(), d.suppress_status_codes = !0, a = rg() + "/" + a.H.Bb + c, b.open(a, d, function(a, b) {
        if (a)
          R(e, a);
        else if (b && b.error) {
